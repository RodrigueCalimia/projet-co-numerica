 ...
 */
class WPDocs_Walker_Nav_Menu_User extends Walker_Nav_Menu {

	private $menuClass 			    = 'menu__list';      // Classe du menu ul, non utilisé car modifier dans header.php
	private $menuItemClass 			= 'menu_user__item';      
	private $menuItemCurrentClass   = '-current';
	private $menuItemDropdownClass  = '-hasDropdown';
	private $menuItemBtn			= '-btn';
	private $menuLinkClass 			= 'menu_user__link';
